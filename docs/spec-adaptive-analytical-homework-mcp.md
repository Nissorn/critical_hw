...
- GitHub repository: https://github.com/Nissorn/critical_hw. Approved implementation tickets are published as issues 1–6 with `ready-for-agent` labels and native blocking dependencies.
